...
a = 5 # a is int
a = 'mk' # a is string now (variables will be updated when u assign different value to same variable)
print(a)
...
print(t,r)
#if you convert boolean to string if its True the output is 1 or if its False the output will be 0
e = int(True)
f = int(False)
print(e,f)
...
print(a+b+c) #but there wont be any space btw words
...
print("Python is " + x) #tow same types can be print by using "+" sign
